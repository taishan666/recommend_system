...
import org.lenskit.bias.GlobalAverageRatingBiasModelProvider;
...
public class LenskitBaseLine {
    ...
    public static void main(String[] args) throws IOException {
        ...
        GlobalAverageRatingBiasModelProvider provider=new GlobalAverageRatingBiasModelProvider(dao);
        config.addComponent(provider.get());
     ...
     //   config.bind(UserMeanBaseline.class,ItemScorer.class).to(UserMeanItemScorer.class);
